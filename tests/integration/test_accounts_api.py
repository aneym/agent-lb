...
async def test_import_kimi_oauth_bundle_and_static_api_key(async_client):
    ...
    static_id = generate_unique_account_id("kimi_static", "static@moonshot.ai")
...
@pytest.mark.asyncio
async def test_update_account_subscription_ledger_does_not_pause_account(async_client):
