...
async def test_settings_api_returns_known_additional_quota_policies(async_client):
    ...
    assert policies_by_key == {
        ...
        "openrouter_credits": {
            "quotaKey": "openrouter_credits",
            "displayLabel": "OpenRouter credits",
            "routingPolicy": "normal",
            "modelIds": [
                "gpt_5_6_sol",
                "minimax_minimax_m2_5",
                "mistralai_devstral_2512",
                "moonshotai_kimi_k2_5",
                "moonshotai_kimi_k2_5_0127",
                ...
                "qwen_qwen3_coder_480b_a35b_07_25",
                ...
                "z_ai_glm_5_2",
                "z_ai_glm_5_3",
                "z_ai_glm_5_3_20260816",
                "z_ai_glm_5_3_flash",
            ],
        },
        "anthropic_catalog": {
            "quotaKey": "anthropic_catalog",
            "displayLabel": "Anthropic catalog",
            "routingPolicy": "normal",
            "modelIds": ["claude_fable_5_1", "claude_opus_5"],
        },
        "openai_subscription": {
            "quotaKey": "openai_subscription",
            "displayLabel": "OpenAI subscription",
            "routingPolicy": "normal",
            "modelIds": ["gpt_5_6_luna", "gpt_6_astra"],
        },
    }
