...
- [x] Correlate both incident logs with request history and account selection.
- [x] Recognize the exact invalid-anchor payload without widening arbitrary invalid-request handling.
- [x] Normalize omitted error code in the websocket rewrite path.
