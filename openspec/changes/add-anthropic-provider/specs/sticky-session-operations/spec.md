...
- **THEN** agent-lb sends both requests through the same Anthropic account
...
- **THEN** agent-lb selects the eligible account and updates the durable sticky mapping for subsequent turns
