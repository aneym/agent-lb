## 1. Policy configuration installer

- [x] 1.1 Add canonical managed adapter templates and version the CCDEX GPT-only hook.
- [x] 1.2 Implement preservation-safe Markdown and Claude settings convergence with preview support.
- [x] 1.3 Extend the shell installer to link the guard hook and invoke policy configuration convergence.
