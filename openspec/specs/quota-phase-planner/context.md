...
The scheduler runs through the existing durable leader-election path every `AGENT_LB_QUOTA_PLANNER_TICK_SECONDS`
seconds, defaulting to five minutes. It can be disabled with `AGENT_LB_QUOTA_PLANNER_SCHEDULER_ENABLED=false`.
