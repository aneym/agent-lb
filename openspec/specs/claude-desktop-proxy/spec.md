# claude-desktop-proxy Specification

## Purpose

Define the durable macOS proxy contract that routes Claude Desktop's embedded Claude Code Messages traffic through agent-lb while leaving Anthropic-owned auxiliary APIs first-party.
