# instance-federation Specification

## Purpose

Define how independent agent-lb instances mirror account routing state, preserve credential ownership, and direct account-authentication operations to the owning instance.
