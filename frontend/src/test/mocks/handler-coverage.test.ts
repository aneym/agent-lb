...
const EXPECTED_ENDPOINTS = [
	...
	"GET /api/accounts/:accountId/rate-limit-reset-credits",
	"POST /api/accounts/:accountId/rate-limit-reset-credits/consume",
	"POST /api/accounts/:accountId/subscription/check",
