...
class AnthropicCompatProfile:
    ...
    upstream_settings_attr: str | None
...
ANTHROPIC_COMPAT_PROFILES: tuple[AnthropicCompatProfile, ...] = (
    ...
    AnthropicCompatProfile(
        ...
        model_prefixes=(),
        messages_quota_key="openrouter_credits",
        messages_thinking_quota_key="openrouter_credits",
        count_tokens_quota_key="openrouter_count_tokens",
        sticky_prefix="openrouter",
        label="OpenRouter",
        no_available_accounts_code="no_available_openrouter_accounts",
        quota_cooldown_code="openrouter_quota_cooldown",
        other_provider_routing_message="Subscription accounts are not eligible for OpenRouter routing.",
        upstream_settings_attr=None,
        upstream_base_url="https://openrouter.ai/api",
        default_probe_model="openai/gpt-5.6-sol",
        import_defaults=AnthropicCompatImportDefaults(
            email="openrouter@openrouter.ai",
            alias="OpenRouter",
            plan_type="openrouter",
            account_id_seed="openrouter",
        ),
        supports_upstream_count_tokens=False,
    ),
)
