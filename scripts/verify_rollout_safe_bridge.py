...
def _parse_args() -> VerifyConfig:
    ...
    parser.add_argument("--host", default="agent-lb.localtest.me")
    ...
    parser.add_argument("--rollout-namespace", default="agent-lb-e2e")
    parser.add_argument("--rollout-context", default="kind-agent-lb-local")
    parser.add_argument("--rollout-target", default="statefulset/agent-lb-e2e-workload")
    parser.add_argument("--delete-owner-after-first-turn", action="store_true")
    parser.add_argument("--postgresql-pod", default="agent-lb-e2e-postgresql-0")
    parser.add_argument("--postgresql-user", default="agentlb")
    parser.add_argument("--postgresql-database", default="agentlb")
    parser.add_argument("--postgresql-secret", default="agent-lb-e2e-postgresql")
